...
// Note: To run tests, use this function to encrypt a JSON file with the
// Netflix account credentials (a test account) with a password.
// The `key' and `nonce' can be generated by `getKey', `getNonce' with a
// password of your choice. Make sure to update `credPath' is you're using a
// different location to store the encrypted file.
